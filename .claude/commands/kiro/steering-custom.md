...
2. **Check if template exists**:
   - Load from `.claude/settings/templates/steering-custom/{name}.md` if available
...
4. **Generate custom steering**:
   ...
   - Apply principles from `.claude/settings/rules/steering-principles.md`
...
Templates available in `.claude/settings/templates/steering-custom/`:
