...
3. **Initialize Files Using Templates**:
   - Read `.claude/settings/templates/specs/init.json`
   - Read `.claude/settings/templates/specs/requirements-init.md`
...
- **Template Missing**: If template files don't exist in `.claude/settings/templates/specs/`, report error with specific missing file path and suggest checking repository setup
