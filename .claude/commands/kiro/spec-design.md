...
- `.claude/settings/templates/specs/design.md` for document structure
- `.claude/settings/rules/design-principles.md` for design principles
- `.claude/settings/templates/specs/research.md` for discovery log structure
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.claude/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.claude/settings/rules/design-discovery-light.md`
...
- Read `.claude/settings/templates/specs/design.md` for structure
- Read `.claude/settings/rules/design-principles.md` for principles
...
**Note**: The actual design document follows `.claude/settings/templates/specs/design.md` structure.
...
**Template Missing**:
- **User Message**: "Template file missing at `.claude/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.claude/settings/rules/design-discovery-full.md`)
