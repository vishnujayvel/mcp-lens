...
1. Load templates from `.claude/settings/templates/steering/`
...
5. Load principles from `.claude/settings/rules/steering-principles.md`
...
From `.claude/settings/rules/steering-principles.md`:
...
- `.claude/settings/` content should NOT be documented in steering files (settings are metadata, not project knowledge)
