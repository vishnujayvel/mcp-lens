...
- Read `.claude/settings/rules/tasks-generation.md` for principles
- If `sequential` is **false**: Read `.claude/settings/rules/tasks-parallel-analysis.md` for parallel judgement criteria
- Read `.claude/settings/templates/specs/tasks.md` for format (supports `(P)` markers)
...
- **User Message**: "Template or rules files missing in `.claude/settings/`"
